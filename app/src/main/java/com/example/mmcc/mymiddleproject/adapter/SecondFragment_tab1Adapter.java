...
public class SecondFragment_tab1Adapter extends BaseAdapter {
    ...
    public SecondFragment_tab1Adapter(Context context) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.Leftcard.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (listener!=null)
                        listener.OnLeftClick(materialBean.getDetail_url());
                }
            });
        ...
        holder.Rightcard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (listener!=null)
                    listener.OnRightClick(bean2.getDetail_url());
            }
        });
        return convertView;
    }
