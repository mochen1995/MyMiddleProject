...
public class FirstFragment_tab4 extends Fragment implements IFragmentView, ViewPager.OnPageChangeListener, PullToRefreshBase.OnRefreshListener2, FirstFragment_tab2Adapter.OnTwoLayoutClickListener {
    ...
    public void loadData() {
        //请求数据
        presenter.RequestData(MyUrl.getSchoolUrl(currentPage));
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (mView == null) {
            ...
            initView();
            //请求头部视图数据
            presenter.RequestHeadData(MyUrl.getSchoolHeadUrl());
        }
        return mView;
    }
