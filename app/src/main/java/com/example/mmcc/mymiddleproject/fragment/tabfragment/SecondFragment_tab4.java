...
public class SecondFragment_tab4 extends Fragment implements IFragmentView, ViewPager.OnPageChangeListener, PullToRefreshBase.OnRefreshListener2, SecondFragment_tab1Adapter.OnTwoLayoutClickListener{
    ...
    public void loadData() {
        //请求数据
        presenter.RequestData(MyUrl.getDigitalUrl(currentPage));
    }
